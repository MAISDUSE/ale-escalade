...
$sujet1 = new Sujet("Test","Un petit s'est fait gommer il y aurait pas de message bande de fils de pute ça va bande","Darkos", date("d/m/Y"));
$miseEnAmont1 = substr($sujet1->getDescription(),0,20) . "...";

$sujet2 = new Sujet("Test2","Un petit 2 s'est fait gommer il y aurait pas de message bande de fils de pute ça va bande","Darkos", date("d/m/Y"));
